...
public class CourseTests {
	...
	public void testViewCourse() throws CourseNotFoundException {
		Mockito.when(repo.findBycourseId(1)).thenReturn(
				new Course(1, "Java", "2", LocalDate.parse("2022-11-10"), LocalDate.parse("2022-11-10"), "1000"));
	...
	public void testViewAllCourses() {
		Mockito.when(repo.findAll()).thenReturn(Stream.of(
				new Course(1, "Java", "2", LocalDate.parse("2022-11-10"), LocalDate.parse("2022-11-10"), "1000"),
				new Course(2, "Java 2.0", "3", LocalDate.parse("2022-11-10"), LocalDate.parse("2022-11-10"), "1000"))
