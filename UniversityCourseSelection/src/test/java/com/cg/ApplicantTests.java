...
class ApplicantTests {
	...
	public void TestViewAllApplicantsByStatus() {
		Mockito.when(repo.findByStatus(AdmissionStatus.Applied))
				.thenReturn(Stream
						.of(new Applicant("101", "abc", "9896753420", "12th", 78, AdmissionStatus.Applied),
								new Applicant("102", "abc", "9896752321", "12th", 60, AdmissionStatus.Applied),
								new Applicant("103", "abc", "9890052323", "12th", 60, AdmissionStatus.Applied))
