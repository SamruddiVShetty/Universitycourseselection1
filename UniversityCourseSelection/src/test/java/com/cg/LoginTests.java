...
public class LoginTests {
	...
	public void testLoginAsAdmissionCommiteeMember() {
		Mockito.when(staffRepo.findBystaffId(1)).thenReturn(new UniversityStaffMember(1, "laka", "commitee member"));
	...
	public void testLoginAsUniversityStaffMember() {
		Mockito.when(staffRepo.findBystaffId(1)).thenReturn(new UniversityStaffMember(1, "laka", "staff member"));
